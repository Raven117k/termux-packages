...
##
TERMUX_APP__PACKAGE_NAME="${TERMUX_APP__PACKAGE_NAME:-${TERMUX_APP_PACKAGE:-com.termux}}"
TERMUX_APP_PACKAGE="${TERMUX_APP_PACKAGE:-$TERMUX_APP__PACKAGE_NAME}" # Deprecated alternative variable for `TERMUX_APP__PACKAGE_NAME`
